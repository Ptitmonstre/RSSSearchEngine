...
public static void main(String[] args) throws IOException {
    ...
    while (!s.equalsIgnoreCase("q")) {
      try {
        System.out.println("Enter the full path to add into the index (q=quit): (e.g. /home/you/mydir or c:\\Users\\you\\mydir)");
        System.out.println("[Acceptable file types: .xml, .htm, .html, .txt, pdf]");
        s = br.readLine();
